    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button
                    className={`h-7 min-w-7 shrink-0 flex flex-col items-center justify-center rounded-md 
    ...
    return (
        <DropdownMenu onOpenChange={(open) => {
            ...
            <DropdownMenuContent className={"p-2.5 flex items-center gap-x-2"}>
                ...
                />
                <Button onClick={() => onChange(value)} className={"px-2 h-[30px]"}>
                    Apply
                </Button>
                {
                    editor?.getAttributes("link").href !== undefined && (
                        <Button onClick={onRemove} className={"px-2 h-[30px]"} variant={"destructive"}>
...
const HeadingLevelButton = () => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button
                    className={`h-7 min-w-7 shrink-0 flex items-center justify-center rounded-md 
                    hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm`}
                >
...
const FontFamilyButton = () => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button
                    className={`h-7 w-[120px] shrink-0 flex items-center justify-between rounded-md 
                    hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm`}
                >
                    <span className={"truncate"}>
